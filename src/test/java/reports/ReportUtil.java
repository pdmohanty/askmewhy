...
public class ReportUtil extends DriverScript {
	...
	public static void startTesting(String filename, String testStartTime, String env, String rel, String browser, String testSiteUrl) {
	...
	public static void addTestCase(String testCaseName, String testCaseStartTime, String testCaseEndTime, String status) {
		...
		try {
			...
			if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")) {
				...
				if (description != null) {
					for (int i = 0; i < description.size(); i++) {
						...
						//out.write("<td align=center width=20%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b><a href=file///"+screenShotPath.get(i)+" target=_blank>Screen Shot</a></b></td>");
						else out.write("<td align=center width=20%><FONT COLOR=#153E7E FACE=Arial SIZE=1><b>&nbsp;</b></td>");
						out.write("</tr>");
					}
				}
			...
			//System.out.println(currentDir + "//" + currentSuiteName + "_TC" + tcid + "_" + testCaseName.replaceAll(" ", "_") + ".html"); 
			if (status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip")) out.write("<td width=40% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b>" + testCaseName + "</b></td>\n");
			else out.write("<td width=40% align= center ><FONT COLOR=#153E7E FACE= Arial  SIZE=2><b><a href="+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+".html>"+testCaseName+"</a></b></td>\n");
