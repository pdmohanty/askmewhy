...
public class XlsReader 
{
	...
	public void writeIntoExcel(String sheetName, String colName, String text) throws BiffException, IOException, RowsExceededException, WriteException
	{
		...
		Label label = new Label(colNum, 1, text);
		sheet.addCell(label);
		copy.write();
		copy.close();
	}
